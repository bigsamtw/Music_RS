...
def simulation(q,no):
    ...
    #____________________________LSCORE >= 1.0____________________________________________________________#
    totals = []
    hits_SVD = []
    hits_pop = []
    rating =1.0
    ...
    result.append(avg_satisfactions_SVD)
    result.append(avg_satisfactions_pop)
    #____________________________LSCORE >= 2.0____________________________________________________________#
    totals = []
    hits_SVD = []
    hits_pop = []
    rating =2.0
...
if __name__=='__main__':
    ...
    #____________Calculation R>1.0____________#
    avg_p_SVD = 0
    avg_p_pop = 0
    avg_s_SVD = 0
    avg_s_pop = 0
    ...
    print(avg_p_SVD, avg_p_pop, avg_s_SVD, avg_s_pop)
    #____________Calculation R>2.0____________#
    avg_p_SVD = 0
    avg_p_pop = 0
    avg_s_SVD = 0
    avg_s_pop = 0
    ...
    np.savetxt('result_average', r, delimiter=",")
